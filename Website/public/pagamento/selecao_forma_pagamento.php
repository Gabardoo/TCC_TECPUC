            ...
            <div class="spad">
                <div class="cart-table">
                    ...
                    <form name="formPagamento" action="" id="formPagamento">
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="qntParcelas" id="qntParcelas" class="form-control select-qnt-parcelas">
                        ...
                        <input type="hidden" name="itemId1" id="itemId1" value="itemId1">

                        <input type="hidden" name="itemDescription1" id="itemDescription1" value="itemDescription1">

                        <input type="hidden" name="paymentMethod" id="paymentMethod" value="creditCard">

                        <input type="hidden" name="itemQuantity1" id="itemQuantity1" value="itemQuantity1">

                        <input type="hidden" name="Quantity" id="Quantity" value="Quantity">

                        <input type="hidden" name="itemAmount1" id="itemAmount1" value="itemAmount1">
                        ...
                        <a href="/public/pedido/visualizar_pedido.php" class="site-btn sb-dark">VOLTAR</a>
                    </form>
